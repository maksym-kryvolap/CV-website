export const Footer = () => {
  return (
    <footer className="footer position-relative text--color py-3 py-md-4 mt-5">
      <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center text-center px-md-5 px-lg-5 px-xxl-0">
        <p className="mb-2 mb-md-0">
          &copy; {new Date().getFullYear()} Maksym Kryvolap. All rights
          reserved.
        </p>

        <div className="footer__socials mb-3 mb-md-0">
          <a
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="footer__socials-icon--svg"
            >
